...
class TestAPI(unittest.TestCase):
    ...
    def test_count_char_matches(self):
        self.assertEqual(0, engine.text_service.count_char_matches('ABC', 'BCA'))
        self.assertEqual(1, engine.text_service.count_char_matches('ABC', 'ACB'))
        self.assertEqual(2, engine.text_service.count_char_matches('ABC', 'ABB'))
        self.assertEqual(3, engine.text_service.count_char_matches('ABC', 'ABC'))
